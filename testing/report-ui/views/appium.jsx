      ...
      <div onClick={(e) => e.stopPropagation()}
        ...
        <div style={{ padding: "22px 24px 18px", borderBottom: "1px solid var(--border)", background: `linear-gradient(180deg, ${theme.bg}, transparent 80%)` }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 8 }}>
            {[
              { l: "duration", v: `${test.duration.toFixed(2)}s` },
              { l: "assertions", v: assertions.length - 1 },
              { l: "screenshots", v: screenshots },
              { l: "retries", v: test.status === "flaky" ? "2" : "0" },
            ].map(s => (
        ...
        <div style={{ padding: 24 }}>
            ...
            <div className="grid" style={{ gap: 14 }}>
              ...
              <div style={{
                ...
                <div className="mono" style={{ fontSize: 12.5, color: "var(--text-2)", lineHeight: 1.5 }}>
                  ...
                  {test.status === "fail" && (test.error || "Test failed during execution. See log for details.")}
                  {test.status === "flaky" && `Test passed after 2 retries. Initial run failed due to a stale element. Investigate for race conditions or missing waits.`}
                </div>
              </div>
              ...
              <div className="card">
                ...
                <div className="card-body" style={{ padding: 0 }}>
                  {[
                    ["File", test.file],
                    ["Suite", test.group],
                    ["Framework", "Appium 2.x + flutter-driver"],
                    ["Device", "Pixel 7 · Android 14 · API 34"],
                    ["Started", "2026-05-21 08:42:11 UTC"],
                    ["Duration", `${test.duration.toFixed(2)}s`],
                    ["Worker", "ubuntu-22.04 · runner-04"],
                  ].map(([k, v]) => (
              ...
              <div className="card">
                <div className="card-head"><h3>Assertions</h3><span className="sub">{assertions.length - 1} checks</span></div>
                <div className="card-body" style={{ padding: 0 }}>
          ...
          {tab === "log" && (
            <div className="card">
              <div className="card-head between" style={{ display: "flex", justifyContent: "space-between" }}>
                <h3>Execution log</h3>
                <span className="mono sub" style={{ fontSize: 11 }}>{assertions.length} lines</span>
              </div>
          ...
          {tab === "code" && (
            <div className="card">
              <div className="card-head"><h3 className="mono" style={{ fontSize: 12 }}>{test.file}</h3></div>
          ...
          {tab === "screens" && (
            <div className="card">
              <div className="card-head"><h3>Screenshots</h3><span className="sub">{screenshots} captured</span></div>
